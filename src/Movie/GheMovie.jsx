...
class GheMovie extends Component {
    ...
    imputChange = (event) => {
       ...
       let valueForm = {...this.state.value,[name]:value}
        console.log(valueForm)
    }

    renderGhe = () => {
        return this.danhSachGhe.map((vitri, index) => {
            return <div className='render' key={`vitrighe-${vitri.hang}`}>
                <tr className='render1'>{vitri.hang}
                    <td >
                        <input  name='seats' type="checkbox" />{vitri.danhSachGhe[0].soGhe}
                    </td>

                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[1].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[2].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[3].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[4].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[5].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[6].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[7].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[8].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[9].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[10].soGhe}</td>
                    <td><input  name='seats' type="checkbox" />{vitri.danhSachGhe[11].soGhe}</td>
    ...
    render() {
        return (
            <div className='container-fluid bgMovie py-5'>
                <div>
                    ...
                    <div className='form'>
                        ...
                        <div className='right'>
                            ...
                            <input onChange={(event) => {
                                this.imputChange(event)
                            }} name='number' type="text" className="form-control"/>
                        </div>

                    </div>
                    <div><button className='btn btn-danger my-5'>Lưu Thông Tin Vé</button></div>
                    <div className='vitrighe'>
                        {this.renderGhe()}
                    </div>
                </div>
...
export default connect()(GheMovie)